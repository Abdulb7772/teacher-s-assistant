...
import { getQuizzes, createQuiz, createQuizColumn, updateQuiz, deleteQuiz, deleteQuizColumn, markAbsent } from "../controllers/quizController";
...
router
  .route("/absent")
  .post(protect, adminOnly, markAbsent);
